// ════════════════════════════════════════════════════════════════════════════
// apps/api/src/alpha-core/alpha-ai.service.ts
...
export class AlphaAIService {
  ...
  async removeTrainingExample(userId: string, index: number) {
    ...
    return this.prisma.alphaAI.update({
      where: { userId },
      data: { trainingExamples: existing },
    });
  }
  ...
  async removeKnowledgeEntry(userId: string, index: number) {
    ...
    return this.prisma.alphaAI.update({
      where: { userId },
      data: { knowledgeEntries: existing },
    });
  }
...
${ai.status ? `Status actual: "${ai.status}"` : ''}`);
    ...
    // ── Exemplos de treino ─────────────────────────────────────────────────
    const examples = (ai.trainingExamples as TrainingExample[]) ?? [];
    ...
    // ── Conhecimento extra ─────────────────────────────────────────────────
    const knowledge = (ai.knowledgeEntries as KnowledgeEntry[]) ?? [];
